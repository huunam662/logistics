...
public class InventoryConsignmentRes {
    ...
    private InventoryConsignmentRes.Logistics logistics; // Thông tin vận chuyển – Không bắt buộc
    ...
    @Data
    @NoArgsConstructor
    public static class Logistics extends InventoryDestinationRes.Logistics{
