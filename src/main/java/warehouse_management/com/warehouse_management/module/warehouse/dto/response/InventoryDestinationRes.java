...
@Data
@NoArgsConstructor
public class InventoryDestinationRes {
    ...
    private InventoryDestinationRes.Pricing pricing; // Giá cả – Không bắt buộc
    private InventoryDestinationRes.Logistics logistics; // Thông tin vận chuyển – Không bắt buộc
