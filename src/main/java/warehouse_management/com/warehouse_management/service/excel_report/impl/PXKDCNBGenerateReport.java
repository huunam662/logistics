...
import warehouse_management.com.warehouse_management.dto.excel_report.InventoryDataSetItemDto;
...
public class PXKDCNBGenerateReport implements GenerateReportStrategy {
    ...
    private List<InventoryDataSetItemDto> buildDataSetItems(List<WarehouseTransaction.InventoryItemTicket> inventoryItems) {
        List<InventoryDataSetItemDto> rs = new ArrayList<>();

        for (int i = 0; i < inventoryItems.size(); i++) {
            WarehouseTransaction.InventoryItemTicket item = inventoryItems.get(i);

            InventoryDataSetItemDto dto = new InventoryDataSetItemDto();
